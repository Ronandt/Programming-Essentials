...
namespace PokemonGame
{
    public class Options
    {
        ...
        //e.g Evolved Yuuki as it's not listed
        ...
        public static void DisplayPokemon()
        {
            ...
            foreach (Pokemon x in GetTables.AllTables().OrderBy(o => o.HP))
            {
            ...
            using (PokemonContext db = new PokemonContext())
            {
                Console.WriteLine($"You have: {db.Pokeballs.Where(x => x.Id == 1).First().Counter} Pokeballs");
            }
